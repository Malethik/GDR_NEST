import { Ability, Rage } from '../ability/ability.entity';
...
export class MainCharClass {
  ...
  constructor(
    ...
    this.dadLife = dadLife;
    this.abilities = abilities;
    this.attackBonus = modifiers.attackBonus;
    this.secondAttackBonus = modifiers.secondAttackBonus;
    this.fortitudeSave = modifiers.fortitudeSave;
    this.reflexSave = modifiers.reflexSave;
    this.willSave = modifiers.willSave;
  }
}
